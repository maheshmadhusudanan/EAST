...
def get_avg_font_size(boxes):
    ...
    for box in boxes:
        ...
        print("about to calculate mean for box")
...
def main(argv=None):
    ...
    for img_file in img_list:
        ...
        #meanw, meanh = get_avg_font_size(boxes)
        ...
        if boxes is not None:
            ...
            with open(res_file, 'w') as f:
                for box in boxes:
                    ...
                    #
                    # Detect the text inside 
                    #
                    # print ("******** for Box = "+ str(box[0, 0]) +","+str(box[0, 1])+" -- "+
                    ...
                    if crop_img.size != 0:
                       ...
                       cv2.imwrite(phase2_temp_img_path, crop_img)
                       i += 1
                       #print (txtReader.predict(crop_img))
                       print("writing file ... "+phase2_temp_img_path)
                    #
                    # write output
                    #
                    #f.write('{},{},{},{},{},{},{},{}\r\n'.format(
